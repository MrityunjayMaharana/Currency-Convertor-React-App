...
function CurrencyConvertor() {
  ...
  return (
    <div className='max-w-xl mx-auto my-10 p-10 bg-white rounded-lg shadow-lg'>
      ...
      {converting ? (
          <button disabled type="button" className="text-white bg-indigo-700 focus:ring-4 focus:ring-indigo-300 font-medium rounded-md text-sm px-5 py-3.5 text-center dark:bg-indigo-600 dark:focus:ring-indigo-800 inline-flex items-center transition duration-600 ease-in-out">
